...
_G.packer_plugins = {
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  tagbar = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-devicons",
  ...
  ["vim-dispatch"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/matt/.local/share/nvim/site/pack/packer/opt/vim-dispatch",
    url = "https://github.com/tpope/vim-dispatch"
  },
  ["vim-matchup"] = {
    after_files = { "/home/matt/.local/share/nvim/site/pack/packer/opt/vim-matchup/after/plugin/matchit.vim" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/home/matt/.local/share/nvim/site/pack/packer/opt/vim-matchup",
    url = "https://github.com/andymass/vim-matchup"
  },
  ["wilder.nvim"] = {
    config = { "\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0" },
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/wilder.nvim",
